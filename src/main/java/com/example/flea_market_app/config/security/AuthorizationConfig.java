...
public class AuthorizationConfig {
	...
	public void configureWeb(
		...
		auth
				...
				.requestMatchers("/user/settings", "/user/address/**", "/user/orders", "/user/orders/**", "/user/favorites", "/user/favorites/**", "/product/add", "/items/add", "/product/submit", "/order/confirm", "/payment", "/address").authenticated()
				.requestMatchers("/admin/**").hasRole("ADMIN")
